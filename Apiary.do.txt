...
and inspiration, though I have found local beekeeper clubs to be invaluable for help and advice.
...
FIGURE: [./Farm/ktbh2, width=600 frac=0.8] Made from basic dimensional lumber, nailed. label{fig:ktbh2}

FIGURE: [./Farm/ktbh1, width=600 frac=0.8] Simplicity in design. label{fig:ktbh1}

FIGURE: [./Farm/ktbh, width=600 frac=0.8] With stand. label{fig:ktbh}
...
o screened top for ventilation
...
FIGURE: [./Farm/obshive, width=250 frac=0.8] label{fig:obshive}
...
* Foundationless frames work well as long as they are placed between drawn frames. Still working on regressing bee size, need to pull frames out of other 2 boxes next year and get everthing switched over to foundationless frames. Also need to make some to bars to g* in place of frames to start bars for the TBHs. 
* Hive 3 had a small cluster of bees in it. so I took the bottom 2 boxes full of detritus off, and gave them a new screened bottom board and reduced bottom entrance to see if they can pull through. I should have given them 3 of the frames of honey I harvested.   
...
* I tossed the remnants of Hive 1 and 3 onto the burn pile, they were looking pretty nasty. Hive 4 needs g* get burned, too, it has collapsed on itself.  
* Things that worked this year: regressing to small cell size, foundationless frames, cracking top for better winter ventilation.
*  Things needing work: storing equipment better, doing mite counts, switching over to TBH. 
=== 2010 season ===
* I thought Hive 2 was going to make it, but they ran out of honey in April, and it was a cold spring. so Close. I meant to try bee-lining, but never got the chance. I got a call in late season (October) to come get a swarm, but by the weekend they had froze out. 
