...
1. Action: 
    1. [Zermatt TL3](https://www.zermattarms.com/?page_id=3078)
    1. [Bat Machine Igniter] ( https://www.batmachine.com/actions/igniter-la/)
1. Barrel
    1. Rebarrel from [Hart](https://hartbarrels.com/) with the action work (right here in LaFayette!)
    1. Caliber: 300 WinMag or one of the [6.5mm](https://ammo.com/comparison/6.5x55-vs-65-creedmoor)
...
## Custom PCC as an M21
* I love the 45 acp round for its power, cost, and historical aspect
* Would be aweome to have a rifle that shared ammo with a 1911, but lever actions don't come in 45 acp
* Id love an actual M21, and they do make PCCs in 45 acp, so maybe with some custom furniture and a low power scope, its at least looks similar? And for far less cost?
