...
o Sensors
    o Interior
        ...
        o nonintrusive appliance load monitor
            o "Current sensors": "https://www.digikey.com/en/products/detail/seeed-technology-co-ltd/101990029/5488226"
            o Voltage Sensors
            o Circuit design
        ...
        o Air cleaner
        o Smoke / CO / Propane detectors
        o Entry (pressure change)
        o Woodstove temp
        o Roomba status
    o Exterior
        o Rain
...
o Server
    o "Historian": "https://github.com/GridProtectionAlliance/openhistorian-python"
    o "Dashboard": "https://www.home-assistant.io/"
...
o Build sensor and ARV mechanicals
    ...
    o Assemble microcontroller
    o Assemble relay-integrated power supply
o Determine base controller logic
o Make a dashboard interface in "DisplayIO": "https://learn.adafruit.com/making-a-pyportal-user-interface-displayio?view=all"
o Build flood tank:
    o Triple-tote system:
        o Rock wool media tray
            o Notches in bottom edge for drainage
            o Anchoring for rock wool cubes
                o brass screws along rim, to strech rubber bands over?
                o wooden castellation torun string through?
                o holes for bamboo skewers?
        o Solution tank
            o Air line running into 1 large upside-down air chamber
...
o Start flood event:
    o turn on air pump and close air release valve for until level has stabilized to within 0.25" for 5 minutes
        o Report solution level from both sensors every 15 seconds
    o if it has been more than 20 minutes, terminate on cycle and alert
    o if water detected in overflow tank, terminate on cycle and alert
    o if sensors do not agree on level, alert
    o if solution level falls below 3", alert
o Alert:
    o flash the built-in light
    o play noise
    o send text message

__CODE:__
@@@CODE ./code/microHydroponics/main.py
...
__Feature Set:__
o Handheld SDR
o Use APRS+GPS for tracking mode?
o Use FT8 for long-distance messaging?
o Can be modded to suit the locale and needs of a trip
o Has a base station/ repeater mode
