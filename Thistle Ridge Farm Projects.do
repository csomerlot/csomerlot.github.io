...
o "Pasture Map": "./Farm/Pasture.kml"
...
FIGURE: [./Farm/CompostPanel, width=600 frac=0.8] Composting Bin. label{fig:composting}

FIGURE: [./Farm/ChickenCoop, width=600 frac=0.8] Chicken Coop. label{fig:coop}
...
FIGURE: [./Fiber/Wheel, width=300 frac=0.8] label{fig:wheel1}

FIGURE: [./Fiber/Wheel2.1, width=600 frac=0.8] label{fig:wheel2.1}

FIGURE: [./Fiber/Wheel2.2, width=600 frac=0.8] label{fig:wheel2.2}
...
FIGURE: [./Fiber/PICT2608_T, width=300 frac=0.8] label{fig:weave}
