...
##  North Woods Cottage 
1. This idea came from discussions during New Year's get togethers (JoAnna calls it a commune)
...
1. Structure:
    ...
    1. Accessible and visible top (so no one runs it over) yet protected from the elements and vandalism. Could also site structure on top of it, and size it 
    for lock-box usage as well.
