...
o "Great example design": "https://youtu.be/MsDTfWLLv3Y"
...
o beds for 8
o single-pane windows with inner and outer shutters for security, cost, strength, and warmth
o screen doors downstairs and in loft for ventilation
o suspend gear (canoes, bikes, etc) from rafters
o Mechanicals should be off-grid, minimalistic (see below)
    o heat
        o masonry wood stove
    o light
    ...
    o hot water
        o "propane on-demand": "https://www.amazon.com/dp/B002JLSH5S/?coliid=I3NOBK27OJ5OOF&colid=LXYPR4UA5ISY&psc=1&ref_=lv_ov_lig_dp_it"
        o a 20lb tank will give 8hrs of shower hot water (overhead tank is already room temp!)
    o electricity
        o use a deep cycle battery and inverter, charged from solar cell
        o really should just be used for lights, charging devices, using speakers, etc.
o kitchen
...
FIGURE: [./HappyHippieLifestyle/cottage, width=500 frac=0.8] "Hay Bale House": "https://raw.githubusercontent.com/csomerlot/csomerlot.github.io/master/HappyHippieLifestyle/cottage.png". label{fig:cottage}

FIGURE: [./HappyHippieLifestyle/cottage_4vw, width=800 frac=1.0] "Hay Bale House": "https://raw.githubusercontent.com/csomerlot/csomerlot.github.io/master/HappyHippieLifestyle/cottage_4w.png". label{fig:cottage_4vw}

MOVIE: [https://youtu.be/_KIqC9HkQ_0, width=600 frac=0.8] A-Frame. label{fig:cottage_vid}
...
FIGURE: [./HappyHippieLifestyle/AFrameHalfLoft.png, width=800 frac=1.0] "A Frame plans": "./HappyHippieLifestyle/A Frame Half Loft.png". label{fig:AFrameplans}
...
o Structure:
    o Constructability: Modular size cube built from ICF
    o 95% buried for thermal efficiency, low noise, and security
    o Accessible and visible top (so no one runs it over) yet protected from the elements and vandalism. Could also site structure on top of it, and size it for lock-box usage as well.
    o insulated and dehumidified/heated for consistent temp and low humidity
o Mechanicals
    o Well: some people "do this": "https://www.drillyourownwell.com/" but a lot depends on siting for soil type and depth to water table
    o Pump:  
        o 12v
        o positive dispacement for high pressure, low volume, no priming
        o replaceable
        o can be multiplied in series or parallel for flow or pressure
        o COTS "automotive fuel pump": "https://www.amazon.com/OSIAS-Universal-Replacement-VOLKSWAGEN-0580464070/dp/B073TY5VBV/ref=asc_df_B073TY5VBV/"
    o Storage:
        o Gravity option: Bulk storage ie IBC tote tank
        o Pressure Tank: this shouldn't be large, as a portable water tower should be used for increased capacity
        o Manual (from external) and power-actuated ball valves
        o Overflow
    o Potable treatment:
        o Filter: 50 micron fiber followed by 5 micron charcoal to remove sediment, chemicals, and protozoa AND
        o UV to remove bacteria and viruses OR
        o "RO unit": "https://www.amazon.com/Alberts-Filter-Membrane-Replacement-Connector/dp/B07H2ZCFFR/ref=sr_1_17_sspa"
    o Power:
        o 12v for safety and convenience
        o Battery bank
        o Charger that can handle solar, alternator, generator or line inputs
o Monitoring:
    o pressure between all components
    o storage level and overflow
    o well level and temp
    o vault humidity and temp
    o battery voltage, charge rate, and temp
    o pump current draw, flow rate, and temp
    o vault door alarm
    o local display and telemetry
...
FIGURE: [./HappyHippieLifestyle/Tiny_House_Drawing_v3, width=800 frac=0.8] "Mobile Ski Chalet": "https://raw.githubusercontent.com/csomerlot/csomerlot.github.io/master/HappyHippieLifestyle/TinyHousePlans.pdf". label{fig:skichalet1}
