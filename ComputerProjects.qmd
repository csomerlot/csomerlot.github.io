...
o Tools
    ...
    o ESC bracelet
    o Connector kits (JST PH) and crimpers for making cables
o Parts warehousing
...
o Dev Environment
    o Platforms
        o IaaS: AWS Workspace
        o PaaS: Platform.io
        o Local: Raspberry Pi
    o Software:
        o Fritzing
        o 3D CAD
            o SolidPython (OpenSCAD) (because programming is better)
            o DesignSpark Mechanical
              o Opens .skp!
              o But no linux
            o "Autodesk Fusion": "https://www.autodesk.com/campaigns/fusion-360/factory-experience" (but not free)
        o Blockly
        o Anaconda Python Env
        o Atom
__Projects:__
o Init: Individual project options
    o Basic battle bots
    o Steampunk wearables
    o Ornaments
o Main Missions: Group effort determined by vote
    o Citizen science
...
o wikipedia and media cache
o privacy and ad blocking
...
__BOM:__
o "Common Mobile Compute Platform": "/._ComputerProjects010.html#___sec10" (two, one for testing, one for production)
...
__CODE:__
@@@CODE ./code/route53update.py


__CODE:__
@@@CODE ./code/watcher.py
...
__Feature Set:__
o Custom radio integration
    o GMRS appears to offer best license-free cost-vs-performance, with usable range of a couple miles and cross-compatibility with FRS
    o "Custom-built HAM radio?": "http://projects.somerlot.net/._RoboticsProjects016.html#___sec15"
    o Mesh wifi?
o App-based mixer for phone for multi-audio stream management (GPS, music, and comms at once!)
o Custom handlebar control to only activate mic during push-to-talk, or switch it to VOX for regular hands-free, or turn off music
o Charging bracket
...
__Phasing:__
o Start with wired connectivity, with phone and radio in tank bag (done):
    o "Noise-cancelling earbuds": "https://www.youtube.com/watch?v=4U5ArX7J7ps" but mounting the microphone is the tricky bit
    o Build "stereo-line mixer": "https://www.monoprice.com/product?p_id=10146" to combine radio, phone, and earbuds 
    o Add "handlebar switch": "https://baofengtech.com/product/adapter-3-5mm/" to mic for PTT
...
__Feature Set:__
o Computes and then measures ballistics
  o Variables for load, wind, pressure, distance (via GPS with point averaging)
  o "Trajectory Science lib": "https://pypi.org/project/ballistics/"
  o stores data in a database
o Long-range wifi for networking back to phone
o Camera on target with webcam to phone, records placement in database
o Integrates with a chronograph "like this one": "https://shop.opticsplanet.com/competition-electronics-prochrono-dlx-with-bluetooth.html?_iv_code=2PI-CRO-CEPCDLX-CEI-3820&gclsrc=aw.ds&gclid=Cj0KCQiAj4ecBhD3ARIsAM4Q_jHLQj0npmX-11q3qBX8V61-LgSasbzHsAETmwMLLr9fmUjKxUiL5wQaAtIiEALw_wcB"
